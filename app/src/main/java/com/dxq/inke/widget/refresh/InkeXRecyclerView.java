...
public class InkeXRecyclerView extends RecyclerView {
    ...
    private InkeArrowRefreshHeader mRefreshHeader;
    ...
    public InkeXRecyclerView(Context context) {
        this(context, null);
    }

    public InkeXRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InkeXRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        if (pullRefreshEnabled) {
            mRefreshHeader = new InkeArrowRefreshHeader(getContext());
    ...
    public void refresh() {
        if (pullRefreshEnabled && mLoadingListener != null) {
            mRefreshHeader.setState(InkeArrowRefreshHeader.STATE_REFRESHING);
    ...
    public void setRefreshHeader(InkeArrowRefreshHeader refreshHeader) {
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0
                    && lastVisibleItemPosition >= layoutManager.getItemCount() - 1 && layoutManager.getItemCount() > layoutManager.getChildCount() && !isNoMore && mRefreshHeader.getState() < InkeArrowRefreshHeader.STATE_REFRESHING) {
                isLoadingData = true;
                if (mFootView instanceof LoadingMoreFooter) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isOnTop() && pullRefreshEnabled && appbarState == AppBarStateChangeListener.State.EXPANDED) {
                    ...
                    if (mRefreshHeader.getVisibleHeight() > 0 && mRefreshHeader.getState() < InkeArrowRefreshHeader.STATE_REFRESHING) {
                        return false;
                    }
                }
                break;
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    InkeXRecyclerView.this.setVisibility(View.GONE);
                } else {

                    mEmptyView.setVisibility(View.GONE);
                    InkeXRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
